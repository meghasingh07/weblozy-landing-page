    ...
    <section className="bg-[#0D172A] text-white relative py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-gray-400 mb-6">
          From GitHub to Slack, we offer integrations with tools you love, tools
          you like, and tools you may even feel kinda meh about. Plus, you can
          write your own integrations with our API.
        </p>
        <a
          href="#"
        ...
        >
          Explore our{" "}
          <span className="text-blue-400">Integrations Library</span> &rarr;
        </a>
